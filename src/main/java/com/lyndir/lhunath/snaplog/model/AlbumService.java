...
public interface AlbumService extends MediaProviderService<Album, Media> {
     ...
     *
     * @param token     Request authentication token should authorize {@link Permission#VIEW} on the album to return.
     * @param ownerUser The user that owns the album with the given name.
