...
public interface LinkIDAuthDelegate extends Serializable {
     ...
     *
     * @param target   The wicket page to return to after linkID delegation.
     * @param response The HTTP response on which to write the delegation result.
     * @param request  The HTTP request which requested this delegation.
     */
