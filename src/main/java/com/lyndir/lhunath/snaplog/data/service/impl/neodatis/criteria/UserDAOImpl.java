...
public class UserDAOImpl implements UserDAO {
    ...
    public User findUser(final LinkID linkID) {
        ...
        Objects<User> results = db.getObjects( new CriteriaQuery( User.class, //
                                                                  new EqualCriterion( "linkID", linkID ) ) );
    ...
    public List<User> listUsers(final Predicate<User> predicate) {
        ...
        return ImmutableList.copyOf( Collections2.filter( listUsers(), predicate ) );
    }
}
