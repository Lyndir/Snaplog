package com.lyndir.lhunath.album.webapp.page;
...
import com.lyndir.lhunath.album.webapp.JavaScriptProvider;
import com.lyndir.lhunath.album.webapp.panel.AdministrationPanel;
import com.lyndir.lhunath.album.webapp.panel.AlbumPanel;
import com.lyndir.lhunath.album.webapp.panel.WorkbenchPanel;
...
public class LayoutPage extends WebPage {
    ...
    public LayoutPage() {
        ...
        add( pageTitle, userSummary, headTabsContainer, contentPanel );
    }
